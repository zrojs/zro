...
export type MergeArrayOfObjects<
...
export type MergeMiddlewaresReturnType<
  TArr extends ReadonlyArray<Middleware<any, any>>,
  T1 = {}
...
export type TRouteLoaderData<R extends Route<any, any>> = R extends Route<
  any,
  infer L
>
  ? L
  : never;
export type TRouteParentData<R extends Route<any, any>> = R extends Route<
  any,
  any,
  infer L
>
